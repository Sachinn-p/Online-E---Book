...
def process_payment(payment: PaymentCreate, current_user: dict = Depends(require_auth), db: Session = Depends(get_db)):
...
def get_payment(payment_id: int, current_user: dict = Depends(require_auth), db: Session = Depends(get_db)):
...
def get_payments_by_order(order_id: int, current_user: dict = Depends(require_auth), db: Session = Depends(get_db)):
